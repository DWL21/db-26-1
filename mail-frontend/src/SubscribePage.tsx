  ...
  return (
    <>
      ...
      <div className="field">
        ...
        <input id="codeInput" className="input" type="text" inputMode="numeric"
          maxLength={6} value={value} placeholder="인증번호 6자리 입력"
          onChange={handleChange} autoFocus autoComplete="one-time-code" spellCheck={false} />
      </div>
    </>
  );
}
  ...
  return (
    <div className="mail">
          ...
          items.map((n, i) => (
            <div className="mail__card" key={i}>
              <div className="mail__badges">
                {n.status && (
                  <span className="mail__badge mail__badge--status"
      ...
      <div className="mail__foot">
        <a className="mail__foot-btn" href="https://scatch.ssu.ac.kr/%ea%b3%b5%ec%a7%80%ec%82%ac%ed%95%ad/?f&keyword"
          target="_blank" rel="noopener noreferrer">전체 공지사항 보기</a>
...
export default function SubscribePage() {
  ...
  return (
    <div className="subscribe-page-standalone">
      ...
      <main className="subscribe-standalone__main">
        <div className="wrap">
